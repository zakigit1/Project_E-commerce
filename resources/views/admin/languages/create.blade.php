                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.save.lang')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        />
                                                            ...
                                                            {{-- <input type="checkbox" value="{{ isset($checked) ? '1' : '0' }}"  name="active" id="switcheryColor4"  class="switchery" data-color="success" checked /> --}}
